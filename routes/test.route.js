 ...
 * @route [http://192.168.0.104/api/reports/user]
 */
testRouter.post(
  "/create-new",
  verifyToken,
...
testRouter.get("/result", async (req, res) => {
  ...
  let image =
    "http://192.168.0.104:5000/uploads/testImages/test-1636407520684_0_35.png";
  try {
    ...
    //   axios
    //     .post("http://192.168.0.104:5002/xana", obj)
    //     .then((response) => {
  ...
  // image = image.replace("http://192.168.0.104:5000/", "");
  ...
  // fd.append("img", image);
  // axios
  //   .post("http://192.168.0.104:5002/xana", fd)
  //   .then((res) => {
  //     console.log("res ::: ", res);
  //   })
  //   .catch((err) => {
