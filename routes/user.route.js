 ...
 * @route [http://172.25.224.1/api/user/register]
 */
userRouter.post(
  "/register",
  [
 ...
 * @route [http://172.25.224.1/api/user/register/gmail]
 */
userRouter.post(
  "/register/gmail",
  [
 ...
 * @returns success
 * @type GET
 * @route [http://172.25.224.1/api/user/confirmation/:token]
 */
 ...
 * @route [http://172.25.224.1/api/user/login]
 */
userRouter.post(
  "/login",
 ...
 * @returns success
 * @type POST
 * @route [http://172.25.224.1/api/user/logout]
 */
 ...
 * @returns userObj
 * @type POST
 * @route [http://172.25.224.1/api/user/login/gmail]
 */
 ...
 * @route [http://172.25.224.1/api/user/profile]
 */
userRouter.get(
  "/profile",
  verifyToken,
 ...
 * @params first_name
 * @required access_token
 * @route [http://172.25.224.1/api/user/profile/edit]
 */
userRouter.put(
  "/profile/edit",
  verifyToken,
 ...
 * @params email
 * @required access_token
 * @route [http://172.25.224.1/api/user/forgot-password]
 */
userRouter.post(
  "/forgot-password",
  [body("email").not().isEmpty()],
 ...
 * @returns userId
 * @type get
 * @route [http://172.25.224.1/api/user/reset-password/:token]
 */
 ...
 * @returns success
 * @params email
 * @route [http://172.25.224.1/api/user/resend-code]
 */
 ...
 * @params refreshToken
 * @route [http://172.25.224.1/api/user/refresh-token]
 */
 ...
 * @returns success
 * @params id,password
 * @route [http://172.25.224.1/api/user/update-password]
 */
